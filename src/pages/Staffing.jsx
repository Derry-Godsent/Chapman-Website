...
import { Zap, Shield, Wrench, Droplets, Hammer, Paintbrush, X, ArrowRight, MessageCircle, CheckCircle, Star } from "lucide-react";
...
.st-intro-desc {
  font-family: var(--fb); font-size: 18px; color: var(--gray-text);
...
.st-step {
  ...
  font-family: var(--fh); font-size: 14px; font-weight: 600; color: var(--navy);
}
.st-step-num {
...
.st-card-name {
  font-family: var(--fh); font-size: 20px; font-weight: 800; color: var(--navy); margin-bottom: 4px;
}
.st-card-trade {
  font-family: var(--fb); font-size: 14px; font-weight: 600; color: var(--orange); margin-bottom: 12px;
}
.st-card-exp {
  font-family: var(--fb); font-size: 12px; color: var(--gray-text); margin-bottom: 20px;
}
.st-card-btn {
  display: inline-flex; align-items: center; gap: 8px;
...
.st-modal-overlay {
  ...
  display: flex; align-items: center; justify-content: center;
  padding: 20px;
  animation: st-fade-up .3s var(--ease) forwards;
}
.st-modal {
  background: var(--white);
  border-radius: 32px;
  ...
  overflow-x: hidden;
  box-shadow: 0 40px 100px rgba(0,0,0,.5);
  animation: st-pop-in .4s var(--ease) forwards;
}
.st-modal-header {
...
.st-modal-name {
  font-family: var(--fh); font-size: 28px; font-weight: 900; color: var(--white); margin-bottom: 8px;
}
.st-modal-trade {
  font-family: var(--fb); font-size: 16px; font-weight: 600; color: var(--orange-hi);
}

.st-modal-body { padding: 32px; }
.st-modal-section-title {
  font-family: var(--fh); font-size: 12px; font-weight: 700;
  letter-spacing: .1em; text-transform: uppercase; color: var(--gray-text); margin-bottom: 12px;
}
.st-modal-desc {
  font-family: var(--fb); font-size: 15px; color: var(--navy); line-height: 1.7; margin-bottom: 24px;
}
.st-modal-skills {
...
.st-petition {
  ...
  color: var(--white); margin-bottom: 100px; position: relative; overflow: hidden;
}
.st-petition::before {
...
.st-petition-title {
  font-family: var(--fh); font-size: 32px; font-weight: 900; margin-bottom: 16px; position: relative;
}
.st-petition-desc {
  font-family: var(--fb); font-size: 16px; color: rgba(255,255,255,.8);
...
@media(max-width: 768px) {
  ...
  .st-header { padding: 100px 0 40px; }
...
function StyleTag() {
  useEffect(() => {
    if (document.getElementById("st-css-v2")) return;
    const el = document.createElement("style");
    el.id = "st-css-v2"; el.textContent = CSS;
...
const WORKERS = [
  {
    id: 1, name: "Kwame Mensah", trade: "Master Electrician", exp: "12 Years Experience",
  ...
  {
    id: 2, name: "Samuel Osei", trade: "CCTV & Security", exp: "8 Years Experience",
  ...
  {
    id: 3, name: "Emmanuel Asante", trade: "Senior Plumber", exp: "15 Years Experience",
  ...
  {
    id: 4, name: "Michael Tetteh", trade: "Handyman & Carpenter", exp: "9 Years Experience",
  ...
  {
    id: 5, name: "Daniel Kofi", trade: "Painter & Decorator", exp: "7 Years Experience",
  ...
  {
    id: 6, name: "Comfort Anokye", trade: "Head of Cleaning Staff", exp: "10 Years Experience",
